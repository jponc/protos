...
const (
	ServiceB_Pong_FullMethodName = "/dev.jponc.grpc_rest.serviceb.v1.ServiceB/Pong"
)
...
func (c *serviceBClient) Pong(ctx context.Context, in *PongRequest, opts ...grpc.CallOption) (*PongResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceB_Pong_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServiceB_Pong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceB_Pong_FullMethodName,
	}
...
var ServiceB_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dev.jponc.grpc_rest.serviceb.v1.ServiceB",
	...
	Metadata: "services/serviceb.proto",
}
