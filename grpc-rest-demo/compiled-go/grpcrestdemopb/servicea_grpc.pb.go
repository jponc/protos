...
const (
	ServiceA_Ping_FullMethodName = "/dev.jponc.grpc_rest.servicea.v1.ServiceA/Ping"
)
...
func (c *serviceAClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, ServiceA_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ServiceA_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dev.jponc.grpc_rest.servicea.v1.ServiceA",
	...
	Metadata: "services/servicea.proto",
}
